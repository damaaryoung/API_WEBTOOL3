...
// }
 ...
 $id_pe_ta = $check_ao->id_periksa_agunan_tanah;
       ...
       $reko =  RekomendasiPinjaman::join('trans_ca','trans_ca.id_rekomendasi_pinjaman','=','rekomendasi_pinjaman.id')->first();
        // dd($check_ca->recom_pin);
        $data[] = [
