...
class PenjaminController extends BaseController
{
    ...
    public function store(Request $req, $id_trans)
    {
        $check_transSO = TransSO::where('id', $id_trans)->first();

        if ($check_transSO == null) {
...
//dd($id_penj);
        ...
        //    DB::connection('web')->commit();
            ...
            return response()->json([
                'code'   => 200,
                'status' => 'success',
                'message' => 'POST Penjamin Berhasil',
                'data'   => $id_penj
            ], 200);
        } catch (Exception $e) {
