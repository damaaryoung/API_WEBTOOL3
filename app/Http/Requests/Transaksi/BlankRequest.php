    ...
    public function rules(Request $request)
    {
        ...
        if ($single != null) {
            ...
            $rules = [
                ...
                // 'lamp_kk_pas'               => 'mimes:jpg,jpeg,png',
                ...
                'lamp_ktp_pen.*'             => 'mimes:jpg,jpeg,png',
                'lamp_ktp_pasangan_pen.*'    => 'mimes:jpg,jpeg,png',
                'lamp_kk_pen.*'              => 'mimes:jpg,jpeg,png',
                'lamp_buku_nikah_pen.*'      => 'mimes:jpg,jpeg,png',
                ...
                'agunan_bag_depan.*'      => 'mimes:jpg,jpeg,png',
                'agunan_bag_jalan.*'      => 'mimes:jpg,jpeg,png',
                'agunan_bag_ruangtamu.*'  => 'mimes:jpg,jpeg,png',
                'agunan_bag_kamarmandi.*' => 'mimes:jpg,jpeg,png',
                'agunan_bag_dapur.*'      => 'mimes:jpg,jpeg,png',

                // Agunan Kendaraan
                'tahun.*'                    => 'date_format:Y',
                'tgl_kadaluarsa_pajak.*'     => 'date_format:d-m-Y',
                'tgl_kadaluarsa_stnk.*'      => 'date_format:d-m-Y',
                'lamp_agunan_depan_ken.*'    => 'mimes:jpg,jpeg,png',
                'lamp_agunan_kanan_ken.*'    => 'mimes:jpg,jpeg,png',
                'lamp_agunan_kiri_ken.*'     => 'mimes:jpg,jpeg,png',
                'lamp_agunan_belakang_ken.*' => 'mimes:jpg,jpeg,png',
                'lamp_agunan_dalam_ken.*'    => 'mimes:jpg,jpeg,png',
                ...
                'file_report_mao'    => 'mimes:jpg,jpeg,png',
                'file_report_mca'    => 'mimes:jpg,jpeg,png',
                'status_file_agunan' => 'in:ORIGINAL,CUSTOM',
                'status_file_usaha'  => 'in:ORIGINAL,CUSTOM',
                // 'file_agunan.*'      => 'mimes:jpg,jpeg,png',
                // 'file_usaha.*'       => 'mimes:jpg,jpeg,png',
                'file_lain'          => 'image'
            ];
        }else{
            ...
            $rules = [
                ...
                'lamp_surat_cerai'      => 'mimes:jpg,jpeg,png',
                'lamp_buku_tabungan.*'  => 'mimes:jpg,jpeg,png',
                // 'lamp_ktp'              => 'mimes:jpg,jpeg,png',
                // 'lamp_kk'               => 'mimes:jpg,jpeg,png',
                'lamp_sku.*'            => 'mimes:jpg,jpeg,png',
                'lamp_slip_gaji'        => 'mimes:jpg,jpeg,png',
                'lamp_foto_usaha.*'     => 'mimes:jpg,jpeg,png',
