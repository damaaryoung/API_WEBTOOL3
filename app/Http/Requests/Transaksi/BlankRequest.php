    ...
    public function rules(Request $request)
    {
        ...
        if (!empty($single)) {
            ...
            $rules = [
                ...
                'lamp_surat_cerai'      => 'image',
                'lamp_buku_tabungan.*'  => 'image',
                'lamp_ktp'              => 'image',
                'lamp_kk'               => 'image',
                'lamp_sku.*'            => 'image',
                'lamp_slip_gaji'        => 'image',
                'lamp_foto_usaha.*'     => 'image',
                ...
                'lamp_ktp_pen.*'             => 'image',
                'lamp_ktp_pasangan_pen.*'    => 'image',
                'lamp_kk_pen.*'              => 'image',
                'lamp_buku_nikah_pen.*'      => 'image',
                ...
                'agunan_bag_depan.*'      => 'image',
                'agunan_bag_jalan.*'      => 'image',
                'agunan_bag_ruangtamu.*'  => 'image',
                'agunan_bag_kamarmandi.*' => 'image',
                'agunan_bag_dapur.*'      => 'image',

                // Agunan Kendaraan
                'tahun.*'                    => 'date_format:Y',
                'tgl_kadaluarsa_pajak.*'     => 'date_format:d-m-Y',
                'tgl_kadaluarsa_stnk.*'      => 'date_format:d-m-Y',
                'lamp_agunan_depan_ken.*'    => 'image',
                'lamp_agunan_kanan_ken.*'    => 'image',
                'lamp_agunan_kiri_ken.*'     => 'image',
                'lamp_agunan_belakang_ken.*' => 'image',
                'lamp_agunan_dalam_ken.*'    => 'image',
                ...
                'file_report_mao'    => 'image',
                'file_report_mca'    => 'image',
