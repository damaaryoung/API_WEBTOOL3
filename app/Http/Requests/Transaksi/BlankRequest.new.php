...
class BlankRequest extends FormRequest
{
    ...
    public function rules(Request $request)
    {
        ...
        if (!empty($single)) {
            ...
            if ($trans && $trans->id_calon_debt != null) {
                $no_ktp    = 'digits:16|unique:web.calon_debitur,no_ktp,'.$trans->id_calon_debt;
                $no_ktp = 'digits:16|unique:web.calon_debitur,no_ktp_kk,'.$trans->id_calon_debt;
            ...
            if ($trans && $trans->id_pasangan != null) {
            ...
            if ($trans && $trans->id_penjamin != null) {
            ...
            $rules = [
                ...
                'no_ktp'                => $no_ktp, //'|unique:web.calon_debitur,no_ktp,'.$trans->id_calon_debt,
                'no_ktp_kk'             => $no_ktp_kk, //'|unique:web.calon_debitur,no_ktp_kk,'.$trans->id_calon_debt,
                'no_kk'                 => $no_kk,//'|unique:web.calon_debitur,no_kk,'.$trans->id_calon_debt,
                'no_npwp'               => $no_npwp, //'|unique:web.calon_debitur,no_npwp,'.$trans->id_calon_debt,
                ...
                'no_telp'               => $no_telp, //'|unique:web.calon_debitur,no_telp,'.$trans->id_calon_debt,
                // 'no_hp'                 => 'between:11,13|unique:web.calon_debitur,no_hp,'.$trans->id_calon_debt,
                ...
                'no_ktp_pas'                => $no_ktp_pas,
                'no_ktp_kk_pas'             => $no_ktp_kk_pas,
                'no_npwp_pas'               => $no_kk_pas,
                'no_npwp_pas'               => $no_npwp_pas,
                'no_telp_pas'               => $no_telp_pas,
            ...
            $check_deb = Debitur::where('no_ktp', $request->no_ktp)->first();

            if ($check_deb && $check_deb->id != null) {

                $no_ktp    = 'digits:16|unique:web.calon_debitur,no_ktp,'.$check_deb->id;
                $no_ktp_kk = 'digits:16|unique:web.calon_debitur,no_ktp_kk,'.$check_deb->id;
                $no_kk     = 'digits:16|unique:web.calon_debitur,no_kk,'.$check_deb->id;
                $no_npwp   = 'digits:15|unique:web.calon_debitur,no_npwp,'.$check_deb->id;
                $no_telp   = 'between:11,13|unique:web.calon_debitur,no_telp,'.$request->no_telp;
                $no_hp     = 'between:11,13|unique:web.calon_debitur,no_hp,'.$check_deb->id;
            }else{
                $no_ktp    = 'digits:16';
                $no_ktp_kk = 'digits:16';
                $no_kk     = 'digits:16';
            ...
            $check_pas = Pasangan::where('id', $request->no_ktp)->first();

            if ($check_pas && $check_pas->id != null) {
                $no_ktp_pas    = 'digits:16|unique:web.pasangan_calon_debitur,no_ktp,'.$check_pas->id;
                $no_ktp_kk_pas = 'digits:16|unique:web.pasangan_calon_debitur,no_ktp_kk,'.$check_pas->id;
                $no_kk_pas     = 'digits:16|unique:web.pasangan_calon_debitur,no_kk,'.$check_pas->id;
                $no_npwp_pas   = 'digits:15|unique:web.pasangan_calon_debitur,no_npwp,'.$check_pas->id;
                $no_telp_pas   = 'between:11,13|unique:web.pasangan_calon_debitur,no_telp,'.$check_pas->id;
            }else{
                $no_ktp_pas    = 'digits:16';
                $no_ktp_kk_pas = 'digits:16';
                $no_kk_pas     = 'digits:16';
            ...
            $check_pen = Penjamin::where('id', $request->no_ktp)->first();

            if ($check_pen && $check_pen->id != null) {

                $no_ktp_pen  = 'digits:16|unique:web.penjamin_calon_debitur,no_ktp,' . $check_pen->id;
                $no_npwp_pen = 'digits:15|unique:web.penjamin_calon_debitur,no_npwp,' . $check_pen->id;
                $no_telp_pen = 'between:11,13|unique:web.penjamin_calon_debitur,no_telp,' . $check_pen->id;
            }else{
            ...
            $rules = [
                ...
                // Penjamin
                'no_ktp_pen.*'              => $no_ktp_pen,
                'no_npwp_pen.*'             => $no_npwp_pen,
                'no_telp_pen.*'             => $no_telp_pen,
